/* Vendored from mp4-muxer@5.2.2 (MIT, Vanilagy). See ./LICENSE.
 * Original source: https://github.com/Vanilagy/mp4-muxer
 * Loaded via <script> — exposes `window.Mp4Muxer` in the browser.
 */
"use strict";
var Mp4Muxer = (() => {
